...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
		...
		_createClass(App, [{
			...
			value: function componentDidMount() {
				...
				dispatch((0, _actions.fetchTips)());
			}
		}, {
			key: "_changeTabs",
			value: function _changeTabs(label, mark) {
				var dispatch = this.props.dispatch;

				console.log(label + "--" + mark);
				this.setState({ title: label });
				dispatch((0, _actions.fetchTips)(mark));
			}
		}, {
			key: "render",
			value: function render() {
				...
				var tipsList = _props.tipsList;
				var isLoading = _props.isLoading;

				var tipsLi = tipsList.map(function (tip) {
					return _react2.default.createElement(
						"li",
						{ key: tip.id, className: "aui-list-view-cell aui-img" },
						_react2.default.createElement("img", { className: "aui-img-object aui-pull-right", src: tip.author.avatar_url }),
						_react2.default.createElement(
							"div",
							{ className: "aui-img-body" },
							tip.title,
							_react2.default.createElement(
								"p",
								{ className: "aui-ellipsis-2" },
								tip.content
							)
						)
					);
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"header",
						{ className: "aui-bar aui-bar-nav aui-bar-dark fixed" },
						this.state.title
					),
					_react2.default.createElement(_loading2.default, null),
					_react2.default.createElement(
						"ul",
						{ className: "aui-list-view content" },
						tipsLi
					),
					_react2.default.createElement(_footer2.default, { onChangeTabs: this._changeTabs.bind(this) })
				);
			}
		}]);
	...
	App.propTypes = {
		tipsList: _react.PropTypes.array.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getTipsSuccess(tipsList) {
		return {
			type: _actionTypes.POSTS_SUCCESS,
			tips: tipsList,
			isLoading: false
		};
	}
	...
	function fetchTips() {
		...
		return function (dispache) {
			dispache(getAllTips());
			return (0, _isomorphicFetch2.default)("https://cnodejs.org/api/v1/topics?mdrender=false&tab=" + tab).then(function (response) {
				return response.json();
			}).then(function (json) {
				return dispache(getTipsSuccess(json.data));
			});
		};
	}
...
/***/ function(module, exports) {
	...
	var POSTS_TIPS = exports.POSTS_TIPS = "POSTS_TIPS";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = function (_Component) {
		...
		_createClass(Footer, [{
			key: "_changeTabsMiddle",
			value: function _changeTabsMiddle(label, mark) {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					"footer",
					{ className: "aui-nav", id: "aui-footer" },
					_react2.default.createElement(
						"ul",
						{ className: "aui-bar-tab" },
						_react2.default.createElement(
							"li",
							{ ref: ALL, className: "active-warning", onClick: function onClick() {
									return _this2._changeTabsMiddle("首页", ALL);
								} },
							_react2.default.createElement("span", { className: "aui-iconfont aui-icon-home" }),
							_react2.default.createElement(
								"p",
								null,
								"首页"
						...
						_react2.default.createElement(
							"li",
							{ ref: GOOD, onClick: function onClick() {
									return _this2._changeTabsMiddle("精华", GOOD);
								} },
							_react2.default.createElement("span", { className: "aui-iconfont aui-icon-mark" }),
							_react2.default.createElement(
								"p",
								null,
								"精华"
						...
						_react2.default.createElement(
							"li",
							{ ref: SHARE, onClick: function onClick() {
									return _this2._changeTabsMiddle("分享", SHARE);
								} },
							_react2.default.createElement("span", { className: "aui-iconfont aui-icon-like" }),
							_react2.default.createElement(
								"p",
								null,
								"分享"
						...
						_react2.default.createElement(
							"li",
							{ ref: ASK, onClick: function onClick() {
									return _this2._changeTabsMiddle("问答", ASK);
								} },
							_react2.default.createElement("span", { className: "aui-iconfont aui-icon-service" }),
							_react2.default.createElement(
								"p",
								null,
								"问答"
						...
						_react2.default.createElement(
							"li",
							{ ref: JOB, onClick: function onClick() {
									return _this2._changeTabsMiddle("招聘", JOB);
								} },
							_react2.default.createElement("span", { className: "aui-iconfont aui-icon-my" }),
							_react2.default.createElement(
								"p",
								null,
								"招聘"
		...
		_createClass(Loading, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					"div",
					{ className: classes },
					_react2.default.createElement("div", { className: "aui-loading-1" }),
					_react2.default.createElement("div", { className: "aui-loading-2" })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = tipsList;

	var _actionTypes = __webpack_require__(198);

	function tipsList() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? { tips: [], isLoading: false } : arguments[0];
		var action = arguments[1];

		switch (action.type) {
			case _actionTypes.POSTS_TIPS:
				return Object.assign({}, state, { tips: action.tips, isLoading: action.isLoading });
			case _actionTypes.POSTS_SUCCESS:
				return Object.assign({}, state, { tips: action.tips, isLoading: action.isLoading });
			default:
				return state;
		}
